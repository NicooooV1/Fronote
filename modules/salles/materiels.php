...
<div class="content-wrapper">
    ...
    <div class="filter-bar">
        <a href="materiels.php" class="btn <?= !$categorieFiltre ? 'btn-primary' : 'btn-outline' ?>"><?= __('label.tous') ?></a>
        ...
        <div class="card-body">
            <form method="post">
                ...
                <div class="form-grid-3">
                    ...
                    <div class="form-group"><label><?= __('label.categorie') ?></label><select name="categorie" class="form-control"><?php foreach ($categories as $k => $v): ?><option value="<?= $k ?>"><?= $v ?></option><?php endforeach; ?></select></div>
                    ...
                    <div class="form-group"><label><?= __('label.salle') ?></label><select name="salle_id" class="form-control"><option value="">—</option><?php foreach ($salles as $s): ?><option value="<?= $s['id'] ?>"><?= htmlspecialchars($s['nom']) ?></option><?php endforeach; ?></select></div>
                ...
                <button type="submit" class="btn btn-primary" style="margin-top:.5rem;"><i class="fas fa-plus"></i> <?= __('btn.add') ?></button>
            </form>
        </div>
    </div>
    <?php endif; ?>
