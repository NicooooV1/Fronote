...
CREATE TABLE IF NOT EXISTS `evenements` (
  ...
  `rrule` varchar(255) DEFAULT NULL COMMENT 'RRULE string for recurring events (FREQ=...;INTERVAL=...)',
  `exdate` text DEFAULT NULL COMMENT 'Comma-separated list of excluded dates (Ymd) for recurring events',
  `rappel_envoye` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Reminder sent flag (0/1) for the reminder cron',
