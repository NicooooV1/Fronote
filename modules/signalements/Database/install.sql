...
-- Schema complet (anti-harcelement M45) : auteur nullable (anonyme), suivi anonyme
-- (tracking_token), temoins, date_traitement, types cyber/intimidation/exclusion.

CREATE TABLE IF NOT EXISTS `signalements` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `etablissement_id` int(11) NOT NULL DEFAULT 1,
  `auteur_id` int(11) DEFAULT NULL,
  `auteur_type` varchar(20) DEFAULT NULL,
  `type` enum('harcelement','cyber_harcelement','violence','discrimination','intimidation','exclusion','danger','autre') NOT NULL DEFAULT 'autre',
  ...
  KEY `idx_signal_token` (`tracking_token`),
