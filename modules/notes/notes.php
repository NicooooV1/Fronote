...
<?php if (canManageNotes()): ?>
    <a href="form_note.php" class="sidebar-nav-item <?= $_sub === 'form_note.php' ? 'active' : '' ?>"><span class="sidebar-nav-icon"><i class="fas fa-pen-to-square"></i></span><span>Saisie</span></a>
<?php endif; ?>
<?php if ($isStaffNotes): ?>
