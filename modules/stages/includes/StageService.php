...
class StageService
{
    ...
    public function getStages(array $filters = []): array
    {
        ...
        if (!empty($filters['prof_referent_id'])) { $sql .= ' AND s.professeur_referent_id = ?'; $params[] = $filters['prof_referent_id']; }
    ...
    {
        $m = ['brouillon' => 'warning', 'soumis' => 'info', 'valide' => 'primary', 'en_cours' => 'success', 'termine' => 'secondary', 'annule' => 'danger'];
