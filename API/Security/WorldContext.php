...
/**
 * WorldContext — point d'entrée des autorisations des mondes plateforme et
 * établissement (opérateurs vs comptes d'établissement).
 *
 ...
 *
 * Les helpers globaux platformAuthorize()/tenantAuthorize() (cf. Bridge) délèguent ici.
 */
