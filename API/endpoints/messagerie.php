...
require_once MESSAGERIE_DIR . '/core/csrf.php';
require_once MESSAGERIE_DIR . '/core/validator.php';
require_once MESSAGERIE_DIR . '/core/rate_limiter.php';
require_once MESSAGERIE_DIR . '/models/conversation.php';
require_once MESSAGERIE_DIR . '/models/message.php';
require_once MESSAGERIE_DIR . '/models/participant.php';
require_once MESSAGERIE_DIR . '/models/notification.php';
...
function handleParticipants(string $action, array $user): void {
    ...
    switch ($action) {
        ...
        case 'available':
            ...
            $available = getAvailableParticipants($convId, $type, $search);
